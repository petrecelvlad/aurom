...
export const Toolbar: React.FC<ToolbarProps> = ({ 
  ...
  return (
    <div className="flex flex-row flex-wrap items-center gap-4 bg-[#1C1C1E] py-1.5 px-2.5 rounded-sm border border-[#2C2C2E] select-none mb-2">
      {/* Availability Filter */}
      ...
      {/* Karat Filter - standardized alongside the other filters, not isolated */}
      {showKaratFilter ? (
        <div className="flex items-center gap-2">
